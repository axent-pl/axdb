...
func (p *FileStorage[IT, MT, DT]) indexToBytes(index IT, offset int64) []byte {
...
func (p *FileStorage[IT, MT, DT]) indexFromReader(reader *os.File) (IT, int64, error) {
...
func (p *FileStorage[IT, MT, DT]) dataToBytes(data DT, dataBlockSize int) []byte {
...
func (p *FileStorage[IT, MT, DT]) dataFromReader(reader *os.File, offset int64) (DT, error) {
